...
const About = (props) => {
  return(
  <Page>
    <Navbar title="Buenos Aires" backLink="Back" backLinkUrl="/"  />
    <BlockTitle>Characteristics: {props.country.nombre}</BlockTitle>
    
     <Block strong>
      <p>This is a great city with much quantity of population</p>
       </Block>
    {/*
    <Block strong>
